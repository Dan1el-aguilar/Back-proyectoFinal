...
const { addSubject, getAllSubjects, deleteSubject, getSubjectById, updateByIdSubjects, addStudentToSubject } = require('../controllers/subjectControllers')
const route = Router()
...
route.put('/student', addStudentToSubject)
